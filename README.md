...
> **Compatibility:** initial release targets **Ostriv Alpha 5, Patch 9, Hotfix 60 (`0.5.9.60`)**. Future releases of the trainer will follow the **same version numbering as the game itself** — download the trainer release that matches your installed game version. Using a trainer build against a different game version may not work correctly, since it relies on the game's internal memory layout.
